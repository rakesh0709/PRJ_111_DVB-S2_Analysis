...
#figure(
  placement: top,
  scope: "parent",
  image("assets/architecture_diagram.png", width: 88%),
...
#figure(
  image("assets/fig_dashboard_analyzed.png", width: 95%),
...
#figure(
  image("assets/fig_timeline_view.png", width: 95%),
...
#figure(
  image("assets/fig_anomaly_view.png", width: 95%),
...
#figure(
  image("assets/fig_comparison_view.png", width: 95%),
...
#figure(
  image("assets/fig_report_view.png", width: 95%),
